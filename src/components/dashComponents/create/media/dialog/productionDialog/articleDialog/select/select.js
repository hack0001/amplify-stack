			...
			<Select
				...
				onChange={e => {
					if (name === "site") {
						...
						handleInfoChange({
							articleSiteId: e.target.value,
							site: e.target.value,
							productionArticleSiteId: siteSelected[0].productionId,
						});
						...
						handleInfoChange({
							articleUserId: userSelect[0].id,
							productionArticleUserId: userSelect[0].userId,
						});
					} else {
						handleOnChange({
