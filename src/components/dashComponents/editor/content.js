...
const Content = ({
	...
	const renderBlockButton = (type, Icon, tooltip, renderType, index) => {
	...
	const renderMarkButton = (type, Icon, tooltip, renderType, index) => {
	...
	const renderInlineButton = (type, Icon, tooltip, renderType, index) => {
	...
	return (
		<Fragment>
			<Grid container alignItems="center" style={{ padding: 20 }}>
				{editorItems.map(({ type, Icon, tooltip, editorType }, index) => {
					switch (editorType) {
						case "mark":
							return renderMarkButton(type, Icon, tooltip, "main", index);
						case "block":
							return renderBlockButton(type, Icon, tooltip, "main", index);
						case "inline":
							return renderInlineButton(type, Icon, tooltip, "main", index);
						default:
							return <div />;
					}
				})}
